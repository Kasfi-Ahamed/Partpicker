			...
			echo "<form method='post' action='login_form.php'>";
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://docs.google.com/forms/d/e/1FAIpQLSc2Ejo_IzmyhZROuZfiSNnhvC7Aw4bzo8wCedByTblNoTv_BQ/viewform">
							<input type="hidden" name="cmd" value="_cart">
							<input type="hidden" name="business" value="shoppingcart@pc_part_picking_suggestor.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/pc_part_picking_suggestor/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/pc_part_picking_suggestor/cancel.php"/>
									<input type="hidden" name="currency_code" value="৳"/>
									<input type="hidden" name="custom" value="'.$_SESSION["uid"].'"/>
									<input style="float:right;margin-right:80px;" type="image" name="submit"
										src="chkout.png" alt=" Checkout"
										alt="Cash on delivary- The safer, easier way to pay online">
								</form>';
				}
			}
	}
